...
Edit data/levels.json, then run node build.mjs. Commit the generated index.html with its source. Keep one native video player, progressive direct MP4 links, honest picture-in-picture support, no autoplay, and the shared v2 palette/type/theme contract. No global home link. Public route: https://jehlp.net/baba-is-you/; GitHub Pages main/root; no project CNAME.
