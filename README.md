...
1. Put a **game-only cropped** H.264 MP4 (yuv420p, faststart) in `../baba-is-you-media-2/media/` for entries 119 onward by default, using `/baba-is-you-media-2/media/…` in the catalogue. Entries 71–118 remain in `../baba-is-you-media/media/`; entries 1–70 remain in `media/`. Completions 176 (Floodgates), 178 (AB), 179 (Overgrowth), and 181 (Cleaning Service) are the capacity exceptions: use `../baba-is-you-media/media/176-floodgates.mp4`, `../baba-is-you-media/media/178-ab.mp4`, `../baba-is-you-media/media/179-overgrowth.mp4`, and `../baba-is-you-media/media/181-cleaning-service.mp4`, with matching `/baba-is-you-media/media/` catalogue paths. Entries 177, 180, and 182 onward retain the Media2 default. Never add an uncropped desktop recording.
...
GitHub Pages publishes `main` at the repository root. Do not add a CNAME: the custom domain is inherited from the account site. Entries 1–70 keep their media alongside the catalogue. Entries 71–118 use `JWKNT/baba-is-you-media`, published under `https://jehlp.net/baba-is-you-media/`. Entries 119 onward normally use the second companion `JWKNT/baba-is-you-media-2`, under `https://jehlp.net/baba-is-you-media-2/`. Each companion publishes `main` from the root with no CNAME; set up and verify the second site's deployment before its first catalogue link is published. Completions 176, 178, 179, and 181 use the first companion’s available capacity at `/baba-is-you-media/media/176-floodgates.mp4`, `/baba-is-you-media/media/178-ab.mp4`, `/baba-is-you-media/media/179-overgrowth.mp4`, and `/baba-is-you-media/media/181-cleaning-service.mp4`; entries 177, 180, and 182 onward retain the second-companion default. Existing recordings stay at their original URLs.
