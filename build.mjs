...
<link rel="stylesheet" href="assets/styles.css?v=20260905-audit"><script src="assets/player.js?v=20260905-audit" defer></script>
</head><body data-site-tone="ochre">
<a href="#player" class="skip-link">Skip to video</a>
<header class="site-header site-header--identity"><div class="site-brand"><img class="site-mark" src="https://jehlp.net/site-theme/v2/marks/baba-is-you.png" width="32" height="32" alt=""><h1 class="site-title">Baba Is You</h1></div><nav aria-label="Page links"><a href="https://github.com/JWKNT/baba-is-you">Source</a><button class="theme-toggle" type="button" data-theme-toggle aria-label="Use dark theme" aria-pressed="false">◐</button></nav></header>
...
<section class="player-section" aria-labelledby="playing-title" id="player" tabindex="-1">
 ...
 <p class="recording-note" id="recording-note">Silent recordings. Attempts and restarts included.</p>
