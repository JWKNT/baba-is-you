...
<ol class="level-list">${world.levels.map(l => `<li id="${l.id}" data-level="${l.id}" data-number="${l.number}" data-title="${escape(l.title)}" data-poster="${l.poster}" data-seconds="${l.seconds}">
